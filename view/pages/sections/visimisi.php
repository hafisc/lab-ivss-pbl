<!-- Bagian Visi & Misi -->
<!-- Menampilkan pernyataan Visi dan Misi laboratorium -->
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        <?= nl2br(htmlspecialchars($visimisi['visi'] ?? 'Visi belum diatur.')) ?>
                    </p>
                </div>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start gap-3">
                            <span class="text-gray-700 leading-relaxed">
                                <?= nl2br(htmlspecialchars($visimisi['misi'] ?? 'Misi belum diatur.')) ?>
                            </span>
                        </li>
                    </ul>
                </div>
