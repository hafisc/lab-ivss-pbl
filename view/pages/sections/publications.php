<!-- Bagian Sorotan Publikasi -->
<!-- Menampilkan daftar publikasi riset unggulan dengan filter -->
                    ...
                    <div class="swiper-wrapper pb-12">
                        ...
                        <div class="swiper-slide">
                            <div class="group relative bg-blue-50 rounded-2xl p-6 hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
                                ...
                                <!-- Badge Unggulan (Jika sitasi tinggi) -->
                        ...
                        ?>
                            <!-- Tampilan Fallback jika tidak ada data publikasi -->
                            <div class="swiper-slide">
