        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center space-x-3 pt-2">
                    ...
                    <?php endif; ?>
                    <a href="mailto:<?= htmlspecialchars($footer_email) ?>" class="w-10 h-10 bg-white bg-opacity-10 border border-white border-opacity-30 hover:bg-white hover:bg-opacity-20 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <a href="https://instagram.com/jtipolinema" target="_blank" class="w-10 h-10 bg-white bg-opacity-5 border border-white border-opacity-10 hover:bg-blue-600 hover:border-blue-500 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110 group">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                        </svg>
                    </a>
                    <a href="mailto:ivss@polinema.ac.id" class="w-10 h-10 bg-white bg-opacity-5 border border-white border-opacity-10 hover:bg-blue-600 hover:border-blue-500 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110 group">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <?php endif; ?>
                    <li>
                        <a href="#profil" class="text-gray-400 hover:text-blue-500 transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Profil Laboratorium
                    ...
                    <li>
                        <a href="#riset" class="text-gray-400 hover:text-blue-500 transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Riset & Penelitian
                    ...
                    <li>
                        <a href="#fasilitas" class="text-gray-400 hover:text-blue-500 transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Fasilitas Lab
                    ...
                    <li>
                        <a href="#member" class="text-gray-400 hover:text-blue-500 transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Member Lab
                    ...
                    <li>
                        <a href="index.php?page=login" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-blue-500 transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                            Portal Login
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <?php endif; ?>
                    <li class="flex items-start space-x-3 group">
                        <div class="w-9 h-9 bg-white bg-opacity-5 border border-white border-opacity-10 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-white group-hover:bg-opacity-10 transition-colors duration-300">
                        ...
                        <div class="text-xs text-gray-400">
                            <p class="font-medium text-white mb-1">Alamat</p>
                            Gedung Jurusan Teknologi Informasi — Lantai 8 Barat<br>
                    ...
                    <li class="flex items-center space-x-3 group">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 mb-0.5">Email</p>
                            <a href="mailto:<?= htmlspecialchars($footer_email) ?>" class="text-sm text-gray-400 hover:text-white transition-colors"><?= htmlspecialchars($footer_email) ?></a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
                ...
                <p class="text-sm text-gray-500 text-center md:text-left">
                    &copy; <?= date('Y') ?> <span class="text-white font-semibold">Lab IVSS</span> - Jurusan Teknologi Informasi, Politeknik Negeri Malang
                </p>
                <div class="flex items-center space-x-4 text-sm">
