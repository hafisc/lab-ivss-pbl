    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="relative bg-white rounded-2xl max-w-2xl w-full overflow-hidden shadow-2xl transform transition-all animate-fade-in">
            ...
            <div class="p-6">
                ...
                <div class="max-h-40 overflow-y-auto"> <p id="modalDescription" class="text-gray-600 leading-relaxed whitespace-pre-wrap text-sm sm:text-base"></p>
                </div>
            </div>
        </div>
    </div>
    ...
    @keyframes fadeIn {
        ...
        to { opacity: 1; transform: scale(1); }
          ...
          <div id="facilityModal" class="fixed inset-0 z-[9999] hidden overflow-y-auto">
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                <div class="relative bg-white rounded-2xl max-w-2xl w-full overflow-hidden shadow-2xl transform transition-all">
                    <button onclick="closeModal()" class="absolute top-4 right-4 z-10 bg-black/50 text-white rounded-full p-2 hover:bg-black">
                    ...
                    <div class="p-8">
                        ...
                        <p id="modalDescription" class="text-gray-600 leading-relaxed" style="white-space: pre-wrap;"></p>
                    </div>
                </div>
            </div>
        </div>
