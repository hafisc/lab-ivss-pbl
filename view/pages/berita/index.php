<?php
// Pastikan variabel $latestNews tersedia.
?>
            ...
            <div class="relative news-swiper-container">
                <div class="swiper newsSwiper">
                    <div class="swiper-wrapper pb-12">
                        <?php
                        if (!empty($latestNews) && is_array($latestNews) && count($latestNews) > 0):
...
<script>
    const newsCount = <?php echo !empty($latestNews) ? count($latestNews) : 0; ?>;
    let newsSwiper = null;
