...
<aside id="sidebar" class="fixed left-0 top-0 w-60 h-screen bg-white border-r border-slate-200 flex flex-col z-40 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out shadow-2xl">
    ...
    <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
        ...
        <!-- Footer & Navbar Management (Untuk Admin & Ketua Lab) -->
        <?php if (in_array($userRole, ['admin', 'ketua_lab'])): ?>
            <div class="border-t border-slate-200 mt-3 pt-3 space-y-1">
                <a href="index.php?page=admin-navbar" class="block px-3 py-2 rounded-lg text-sm transition-colors <?= $currentPage === 'admin-navbar' ? 'bg-blue-900 text-white font-medium' : 'text-slate-700 hover:bg-slate-100' ?>">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="index.php?page=admin-footer" class="block px-3 py-2 rounded-lg text-sm transition-colors <?= $currentPage === 'admin-footer' ? 'bg-blue-900 text-white font-medium' : 'text-slate-700 hover:bg-slate-100' ?>">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
