    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5 hover:shadow-md transition-shadow">
        <div class="flex items-start justify-between gap-4">
            ...
            <div class="flex flex-col gap-2">
                <a href="index.php?page=admin-publications&action=edit&id=<?= $pub['id'] ?>" 
                        class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors inline-block" 
                        title="Edit">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                    </svg>
                </button>
                <a href="index.php?page=admin-publications&action=delete&id=<?= $pub['id'] ?>" onclick="return confirm('Hapus publikasi ini?')"
                        class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors inline-block" 
                        title="Hapus">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
