        ...
        <form method="POST" action="index.php?page=register" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select
                        ...
                        <?php if (!empty($supervisors) && is_array($supervisors)): ?>
                            <?php foreach ($supervisors as $sp): ?>
                                <option value="<?= htmlspecialchars($sp['id']) ?>"><?= htmlspecialchars($sp['name']) ?><?php if (!empty($sp['origin'])): ?> - <?= htmlspecialchars($sp['origin']) ?><?php endif; ?></option>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <!-- Fallback: hardcoded options jika DB kosong -->
            ...
            <div>
                ...
                <textarea
                    ...
                    placeholder="Jelaskan motivasi Anda bergabung dengan Lab IVSS dan mengapa Anda tertarik dengan topik penelitian yang dipilih..."></textarea>
